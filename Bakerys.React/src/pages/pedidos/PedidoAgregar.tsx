...
export default function PedidoAgregar() {
  ...
  useEffect(() => {
    clienteService.getAll().then(r => setClientes(r.data.filter(c => c.activo)))
  }, [])
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28 }}>
        <div>
          <h1 style={pageTitle}>Nuevo Pedido</h1>
          <p style={pageSub}>Crear un pedido para un cliente</p>
        </div>
      ...
      <div style={{ maxWidth: 560 }}>
        <div style={cardStyle}>
          <div style={cardHeader}><span style={cardTitle}>📋 Datos del Pedido</span></div>
